...
func (s *PostgreOrderStore) GetNextId(ctx context.Context,) int {
	return query.GetNextAvailableOrderId(ctx)
}
...
func (s *PostgreOrderStore) Get(ctx context.Context, id int) (model.Order, error) {
	...
	order.Items, err = query.GetItemsByOrderId(ctx, id)

	return order, err
}

func (s *PostgreOrderStore) Create(
	ctx context.Context,
	tx pgx.Tx,
	order model.Order,
) (model.Order, error) {
...
func (s *PostgreOrderStore) Update(
	ctx context.Context,
	tx pgx.Tx,
	order model.Order,
) (model.Order, error) {
