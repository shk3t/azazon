...
type UpdateUserRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Token         string                 `protobuf:"bytes,1,opt,name=token,proto3" json:"token,omitempty"`
	NewLogin      *string                `protobuf:"bytes,2,opt,name=new_login,json=newLogin,proto3,oneof" json:"new_login,omitempty"`
...
const file_auth_proto_rawDesc = "" +
	...
	"\x05valid\x18\x01 \x01(\bR\x05valid\"\xbf\x01\n" +
	"\x11UpdateUserRequest\x12\x14\n" +
	"\x05token\x18\x01 \x01(\tR\x05token\x12 \n" +
	"\tnew_login\x18\x02 \x01(\tH\x00R\bnewLogin\x88\x01\x01\x12&\n" +
	"\fnew_password\x18\x03 \x01(\tH\x01R\vnewPassword\x88\x01\x01\x12\x1e\n" +
	"\brole_key\x18\x04 \x01(\tH\x02R\aroleKey\x88\x01\x01B\f\n" +
	"\n" +
	"_new_loginB\x0f\n" +
	"\r_new_passwordB\v\n" +
	"\t_role_key\"*\n" +
	...
	"\n" +
	"UpdateUser\x12\x17.auth.UpdateUserRequest\x1a\x18.auth.UpdateUserResponseB\x1aZ\x18common/internal/api/authb\x06proto3"
